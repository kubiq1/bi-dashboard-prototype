        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              variant="outline"
              size="sm"
              className="bg-[#00e47c] text-[#08312a] border-[#00e47c] hover:bg-[#00d46b] hover:text-[#08312a] rounded-none shadow-none [&_svg]:text-[#08312a]"
            >
              Show all Clusters
            </Button>
          </div>
        ...
        <section>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            ...
            <div className="flex flex-col lg:flex-row gap-3">
              ...
              {/* Department Filter */}
              <Select>
                <SelectTrigger className="w-full sm:w-40 bg-[#00e47c] text-[#08312a] border-[#00e47c] hover:bg-[#00d46b] focus:bg-[#00e47c] rounded-none shadow-none [&_svg]:text-[#08312a]">
              ...
              <Select>
                <SelectTrigger className="w-full sm:w-44 bg-[#00e47c] text-[#08312a] border-[#00e47c] hover:bg-[#00d46b] focus:bg-[#00e47c] rounded-none shadow-none [&_svg]:text-[#08312a]">
                  <Filter className="h-4 w-4 mr-2 text-[#08312a]" />
              ...
              {/* Cluster Filter */}
              <Select>
                <SelectTrigger className="w-full sm:w-36 bg-[#00e47c] text-[#08312a] border-[#00e47c] hover:bg-[#00d46b] focus:bg-[#00e47c] rounded-none shadow-none [&_svg]:text-[#08312a]">
                  <Filter className="h-4 w-4 mr-2 text-[#08312a]" />
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                variant="outline"
                size="sm"
                className="bg-[#00e47c] text-[#08312a] border-[#00e47c] hover:bg-[#00d46b] hover:text-[#08312a] rounded-none shadow-none"
              >
                Next
              </Button>
            </div>
